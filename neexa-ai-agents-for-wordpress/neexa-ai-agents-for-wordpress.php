...
function cam_neexai_add_header_script()
{
    ...
    if (!empty($neexa_ai_agents_configs["config_agent_id"])) {
        echo '<script> var neexa_xgmx_cc_wpq_ms = "' . $neexa_ai_agents_configs["config_agent_id"] . '";</script>';
        echo '<script src="https://chat-widget.neexa.ai/main.js?nonce=' . time() . '"></script>';
    }
}
...
function neexa_ai_agents_sanitize_configs($input)
{
...
?>
    <div class="wrap">
        <h2>Neexa.AI Agents Configuration</h2>
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="text" name="neexa_ai_agents_configs[config_agent_id]" value="<?php echo esc_attr(
            ...
            <i>The Agent ID can be got from the <a href="http://app.neexa.ai" target="_blank" rel="noopener noreferrer">neexa.ai dashboard</a></i>
        ...
        <div>
            Need Help Setting Up an AI Agent? <a href="https://wa.me/256743665790" target="_blank">
                CONTACT US NOW
            </a> to support you.
        </div>
    </div>
...
?>
    <div class="wrap">
        ...
        <ol>
            ...
            <li>Click on "Create New AI Agent."</li>
            <li>Give your agent a name and configure any other desired settings.</li>
        </ol>

        <h3>3. Copy the Agent ID</h3>
        <p>
            You'll need to copy the Agent ID associated with your AI agent. Here's how:
        </p>
        <ol>
            <li>Access the "Agent Edit Page" within your Neexa account.</li>
            <li>Locate the unique Agent ID for your AI agent in the "Installation" Section</li>
            <li>Copy this Agent ID to your clipboard.</li>
        </ol>

        <h3>4. Paste the Agent ID into WordPress</h3>
        <p>
            Now, you'll need to integrate your AI agent into your WordPress website:
        </p>
        <ol>
            <li>Log in to your WordPress admin dashboard.</li>
            <li>Find the "AI Agent Integration" settings.</li>
            <li>Paste the Agent ID you copied into the "Agent ID" field.</li>
