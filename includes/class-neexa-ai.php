...
class Neexa_Ai
{
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action("plugin_action_links_neexa-ai/neexa-ai.php", $plugin_admin, 'override_deactivate_link');
		...
		$this->loader->add_action("admin_footer", $plugin_admin, 'render_deactivate_modal');	
